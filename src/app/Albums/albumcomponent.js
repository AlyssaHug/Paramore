...
const AlbumComponent = ({
    ...
    albumDesc = "idk something something",
    albumEnding = "",
    onClose,
}) => {
    return (
        <div className={styles.albumPage}>
            ...
            <section className={styles.albumEnding}>
                <div
                    className={styles.endingBg}
                    style={{
                        backgroundImage: `url(${albumEnding})`,
                    }}
                />
                <p className={styles.albumDescription}>{albumDesc}</p>
            </section>
        </div>
    );
};
