            ...
            <div className={styles.artistbg}>
                <div className={styles.hayley}>
                    ...
                    <div className={styles.hayleyText}>
                        ...
                        <p className={styles.subText}>
                            In August 2025, Hayley released a surprise
                            collection of 17 songs, which were later packaged as
                            the album “Ego Death at a Bachelorette Party” in
                            November with 3 other tracks. She has announced her
                            first solo shows for 2026, something she tried doing
                            for her prior solo work in 2020/2021 but couldn’t
                            due to the pandemic. She is currently working
                            through finding herself outside the identity of
                            Paramore with her solo venture.
                        </p>
                    </div>
                </div>
                ...
                <div className={styles.zac}>
                    <div className={styles.zacText}>
                        ...
                        <p className={styles.subText}>
                            In July 2025, Zac released his debut solo album
                            under his own name. His album “Operator”, explores
                            themes like nostalgia, love, grief, and
                            communication, different from his prior work in
                            Paramore. This music allows him to also explore who
                            he is outside of the band, showing a different side
                            to himself.
                        </p>
                    </div>
                    <img
                ...
                <div className={styles.taylor}>
                    ...
                    <div className={styles.taylorText}>
                        <h2 className={styles.taylorSubhead}>
                            Taylor York{" "}
                            <span className={styles.subName}>Low Profile</span>
                        </h2>
                        <p className={styles.subText}>
                            With the band's wiped social media presence earlier
                            in the year, there was uncertainty with its members.
                            But in September 2025, Taylor re-launched his
                            instagram page listing himself as the band’s
                            guitarist, confirming he remains part of the band.
                            Other than his instagram reboot, his public activity
                            has been minimal, with no links to any side-projects
                            or music this year. The band's break has allowed him
